...
from core.security.auth import verify_security_key
...
class TestSecurity(unittest.TestCase):
    def test_sha256_compat_verify(self):
        ...
        self.assertTrue(verify_security_key("secret", expected))
        self.assertFalse(verify_security_key("wrong", expected))
